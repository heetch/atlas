...
public class RedshiftBridge {
    ...
    public static final String REDSHIFT_DRIVER = "redshift.driver";
    public static final String REDSHIFT_URL = "redshift.url";
    public static final String REDSHIFT_USERNAME = "redshift.username";
    ...
    private JdbcTemplate getJdbcTemplate() {
        ...
        dataSource.setUsername(redshiftUsername);
        dataSource.setPassword(redshiftPassword);
